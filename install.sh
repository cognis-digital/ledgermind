#!/usr/bin/env sh
# Universal installer for ledgermind. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/ledgermind.git"
echo "Installing ledgermind ..."
